...
namespace Xelat.Project.Migrations
{
    ...
    [Migration("20230409151930_AddProductMappingTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xelat.Project.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Xelat.Project.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Xelat.Project.Customers.customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Xelat.Project.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Xelat.Project.Products.product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Xelat.Project.Products.ProductMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Xelat.Project.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Xelat.Project.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Xelat.Project.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Xelat.Project.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Xelat.Project.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Xelat.Project.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Xelat.Project.Products.ProductMapping", b =>
                {
                    b.HasOne("Xelat.Project.Customers.customer", "customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("Xelat.Project.MultiTenancy.Tenant", "Tenant")
                        .WithMany()
